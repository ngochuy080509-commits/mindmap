            ...
            if not video_id:
                ...
                if transcript_data:
                    ...
                    for i, (time_lbl, text) in enumerate(chunks):
                        ...
                        res = generate_content_with_retry(client, MODEL_NAME, prompt)
                    ...
                    res_map = generate_content_with_retry(client, MODEL_NAME, prompt_map)
    ...
    if st.button("🚀 Phân Tích Audio & Tạo Mindmap", type="primary"):
        if not api_key:
            ...
            try:
                ...
                res_audio = generate_content_with_retry(client, MODEL_NAME, [gemini_file, prompt_audio])
